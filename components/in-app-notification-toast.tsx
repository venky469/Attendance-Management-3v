...
// //           console.log("[v0] Notification toast: User not authenticated, skipping check")
// //           return
// //         }
// //         console.error("[v0] Notification toast: HTTP error", response.status)
// //         return
// //       }
...
//   useEffect(() => {
//     const pollInterval = setInterval(checkForNewNotifications, 2000)
