...
// // // //   { href: "/faceid", label: "Face ID", icon: ScanFace, roles: ["SuperAdmin", "Admin", "Manager", "Staff", "Teacher"] },
...
// // // //         setLatestVersion(data.latestUpdate?.version || data.version || "1.0.0")
// // // //       })
// // // //       .catch(() => {})
...
// // // //                 <SheetContent
// // // //                   side="right"
// // // //                   className="w-full sm:w-80 bg-background/95 backdrop-blur-xl border-l border-border/50 p-0"
// // // //                 >
// // // //                   <SheetHeader className="border-b border-border/80 p-4 sm:p-6">
