...
// // // // // // //   { href: "/attendance", label: "Attendance", roles: ["Admin", "Manager", "Staff", "Teacher"] },
// // // // // // //   { href: "/student-attendance", label: "My Attendance", roles: ["Student"] },
// // // // // // //   { href: "/faceid", label: "Face ID", roles: ["SuperAdmin", "Admin", "Manager", "Staff", "Teacher", "Student"] },
...
// // // // // // //   },
// // // // // // //   { href: "/leave-approval", label: "Leave Approval", roles: [ "Admin", "Manager", "Teacher"] },
// // // // // // //   { href: "/reports", label: "Reports", roles: ["SuperAdmin", "Admin", "Manager"] },
// // // // // // //   { href: "/settings", label: "Settings", roles: ["SuperAdmin", "Admin", "Manager"] },
...
// // // // // // //                   <Button
// // // // // // //                     variant="ghost"
// // // // // // //                     className="relative h-9 w-9 rounded-full hover:scale-105 transition-transform duration-200"
// // // // // // //                   >
...
// // // // // // //                     <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-gray-50 to-gray-100/50 rounded-2xl mb-6 border border-gray-200/50">
...
// // // // // // //                         }}
// // // // // // //                         variant="outline"
// // // // // // //                         className="h-12 flex-col space-y-1 hover:bg-teal-50 hover:border-teal-200 transition-all duration-200"
// // // // // // //                       >
...
// // // // // // //                         }}
// // // // // // //                         variant="outline"
// // // // // // //                         className="h-12 flex-col space-y-1 hover:bg-blue-50 hover:border-blue-200 transition-all duration-200"
// // // // // // //                       >
...
// // // // // // //                       <div className="max-h-64 overflow-y-auto scrollbar-hide space-y-2 pr-2">
// // // // // // //                         {links.map((l, index) => (
// // // // // // //                           <Link
// // // // // // //                             key={l.href}
// // // // // // //                             href={l.href}
// // // // // // //                             onClick={(e) => handleNavLinkClick(l.href, e)}
// // // // // // //                             className={cn(
// // // // // // //                               "group relative flex items-center px-4 py-3 rounded-xl text-left font-medium transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] w-full",
// // // // // // //                               "animate-in slide-in-from-right-5 fade-in-0",
// // // // // // //                               pathname === l.href || (l.href.startsWith("#") && activeSection === l.href.substring(1))
// // // // // // //                                 ? "bg-gradient-to-r from-teal-500 to-blue-500 text-white shadow-lg shadow-teal-500/25"
// // // // // // //                                 : "text-gray-700 hover:text-teal-600 hover:bg-gradient-to-r hover:from-teal-50 hover:to-blue-50 border border-gray-200/50 hover:border-teal-200/50 bg-white/80",
// // // // // // //                             )}
// // // // // // //                             style={{ animationDelay: `${index * 50}ms` }}
// // // // // // //                           >
// // // // // // //                             <span className="relative z-10 text-sm font-medium">{l.label}</span>
// // // // // // //                             {(pathname === l.href ||
// // // // // // //                               (l.href.startsWith("#") && activeSection === l.href.substring(1))) && (
// // // // // // //                               <div className="absolute inset-0 bg-gradient-to-r from-teal-400/20 to-blue-400/20 rounded-xl animate-pulse" />
// // // // // // //                             )}
// // // // // // //                           </Link>
// // // // // // //                         ))}
// // // // // // //                       </div>
...
// // // // // // //                             <div className="h-1 w-2 bg-teal-500 rounded-full animate-pulse" />
// // // // // // //                           </div>
// // // // // // //                         </div>
// // // // // // //                       )}
// // // // // // //                     </div>
...
// // // // // // //                         variant="ghost"
// // // // // // //                         className="w-full justify-start px-4 py-3.5 h-auto text-red-600 hover:text-red-700 hover:bg-red-50 rounded-2xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
// // // // // // //                       >
...
// // // // // // const allLinks = [
// // // // // //   { href: "/", label: "Dashboard", roles: ["SuperAdmin", "Admin", "Manager", "Staff", "Teacher", "Student"] },
// // // // // //   { href: "/attendance", label: "Attendance", roles: ["SuperAdmin", "Admin", "Manager", "Staff", "Teacher"] },
// // // // // //   { href: "/student-attendance", label: "My Attendance", roles: ["Student"] },
// // // // // //   { href: "/faceid", label: "Face ID", roles: ["SuperAdmin", "Admin", "Manager", "Staff", "Teacher", "Student"] },
// // // // // //   { href: "/staff", label: "Staff", roles: ["SuperAdmin", "Admin", "Manager"] },
// // // // // //   { href: "/students", label: "Students", roles: ["SuperAdmin", "Admin", "Manager", "Teacher"] },
...
// // // // //     .filter((l) => serviceLabels.includes(l.label))
// // // // //     .sort((a, b) => serviceLabels.indexOf(a.label) - serviceLabels.indexOf(b.label))
...
// // // // //                     {servicesLinks
// // // // //                       .filter((l) =>
// // // // //                         ["Attendance", "My Attendance", "Face ID", "My Leave Requests", "Leave Approval"].includes(
// // // // //                           l.label,
// // // // //                         ),
// // // // //                       )
// // // // //                       .map((l) => (
...
// // // // //                     {servicesLinks
// // // // //                       .filter((l) => ["Staff", "Students"].includes(l.label))
// // // // //                       .map((l) => (
// // // // //                         <DropdownMenuItem key={l.href} asChild>
// // // // //                           <Link href={l.href} onClick={() => setIsOpen(false)}>
// // // // //                             {l.label}
...
// // // // //                     {servicesLinks
// // // // //                       .filter((l) => ["Reports", "Notifications"].includes(l.label))
// // // // //                       .map((l) => (
// // // // //                         <DropdownMenuItem key={l.href} asChild>
// // // // //                           <Link href={l.href} onClick={() => setIsOpen(false)}>
// // // // //                             {l.label}
