...
// // //             <img src="/logo3.png" alt="FaceAttendance" className="h-24 w-24 rounded-2xl shadow-lg object-cover" />
...
// //         <div className="text-center mb-8 animate-in fade-in slide-in-from-top duration-700">
// //           <div className="inline-flex items-center gap-3 mb-4">
// //             <img src="/logo3.png" alt="Face Attendance" className="h-24 w-24 rounded-2xl shadow-lg object-cover" />
// //             <h1 className="text-5xl font-bold bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 bg-clip-text text-transparent text-balance">
// //               FaceAttendence
// //             </h1>
// //           </div>
...
//         <div className="text-center mb-8 animate-in fade-in slide-in-from-top duration-700">
//           <div className="inline-flex items-center gap-3 mb-4">
//             <img src="/logo3.png" alt="FaceAttendence" className="h-24 w-24 rounded-2xl shadow-lg object-cover" />
//             <h1 className="text-5xl font-bold bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 bg-clip-text text-transparent text-balance">
//               FaceAttendence
//             </h1>
//           </div>
