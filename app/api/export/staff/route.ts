...
//       Shift: staff.shift?.name || "N/A",
//       "HR Code": staff.hrCode || "N/A",
//       "Phone Number": staff.phoneNumber || "N/A",
...
// \\hline
// \\textbf{Name} & \\textbf{Email} & \\textbf{Code} & \\textbf{Role} & \\textbf{Dept} & \\textbf{Shift} \\\\
// \\hline
// \\endhead
// ${exportData
//   .map(
//     (staff) =>
//       `${staff.Name} & ${staff.Email} & ${staff["Employee Code"]} & ${staff.Role} & ${staff.Department} & ${staff.Shift} \\\\\\hline`,
//   )
//   .join("\n")}
// \\end{longtable}
