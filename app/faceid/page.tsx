...
// // import { LivenessDetector, type LivenessChallenge, detectScreenSpoof } from "@/lib/liveness-detection"
// // import LivenessCheckPrompt from "@/components/liveness-check-prompt"
...
// //   const [livenessDetector] = useState(() => new LivenessDetector())
...
// //   const lastSpoofResultRef = useRef<Map<string, boolean>>(new Map()) // faceId -> isSpoof
...
// //   useEffect(() => {
// //     // Load liveness setting from localStorage
// //     const saved = localStorage.getItem("livenessDetectionEnabled")
// //     if (saved !== null) {
...
// //       if (livenessEnabled && faceQuality >= 0.6) {
// //         try {
// //           // Get image data for screen spoof detection
...
// //           // Get image data for screen spoof detection
// //           const imageData = fctx.getImageData(0, 0, faceCanvas.width, faceCanvas.height)
// //           const spoofResult = detectScreenSpoof(imageData)

// //           const faceId = `${Math.floor(cx)}_${Math.floor(cy)}`
// //           const lastResult = lastSpoofResultRef.current.get(faceId)

// //           if (spoofResult.isSpoof) {
// //             // Draw orange box for detected screen spoof
// //             ctx.strokeStyle = "rgba(251, 191, 36, 0.95)"
// //             ctx.lineWidth = 3
// //             ctx.strokeRect(sx, sy, sw, sh)

// //             const label = `Screen Spoof Detected (${(spoofResult.confidence * 100).toFixed(0)}%)`
// //             ctx.fillStyle = "rgba(251, 191, 36, 0.95)"
// //             ctx.font = "12px sans-serif"
...
// //             if (lastResult !== true) {
// //               logMsg(`Screen spoof detected: ${spoofResult.reason}`)
// //               lastSpoofResultRef.current.set(faceId, true)
// //             }
// //             continue // Skip this face
// //           } else {
// //             // Update the tracking state without logging
// //             if (lastResult === true || lastResult === undefined) {
// //               lastSpoofResultRef.current.set(faceId, false)
// //             }
// //           }
// //         } catch (e) {
// //           console.error("[v0] Screen spoof detection error", e)
// //         }
// //       }
...
// //           {livenessEnabled && " Screen spoof detection enabled to prevent photo/video attacks."}
// //         </p>
// //       </header>
...
// //               <label className="text-sm font-medium">Screen Spoof Detection</label>
// //               <p className="text-xs text-muted-foreground">
// //                 Prevent cheating using photos or videos of screens. Detects screen artifacts and patterns.
// //               </p>
// //             </div>
// //             <button
// //               onClick={() => {
// //                 const newValue = !livenessEnabled
// //                 setLivenessEnabled(newValue)
// //                 localStorage.setItem("livenessDetectionEnabled", String(newValue))
// //                 livenessDetector.reset()
// //                 logMsg(`Anti-spoofing ${newValue ? "enabled" : "disabled"}`)
// //               }}
// //               className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
// //                 livenessEnabled ? "bg-primary" : "bg-gray-200"
// //               }`}
// //             >
// //               <span
...
//   useEffect(() => {
//     // Load anti-spoof setting from localStorage
...
//         try {
//           // Get image data for head movement analysis
//           const faceCanvas = document.createElement("canvas")
//           faceCanvas.width = Math.max(1, Math.floor(sw))
//           faceCanvas.height = Math.max(1, Math.floor(sh))
//           const fctx = faceCanvas.getContext("2d")
...
//           // Draw full frame for background analysis
...
//             // Draw orange box for detected spoof
//             ctx.strokeStyle = "rgba(251, 191, 36, 0.95)"
//             ctx.lineWidth = 3
//             ctx.strokeRect(sx, sy, sw, sh)
...
//           }
//         } catch (e) {
//           console.error("[v0] Head movement detection error", e)
//         }
//       }
