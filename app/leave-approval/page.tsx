...
// // import { Calendar, Clock, FileText, Check, X, Eye, Mail, History, Download, ExternalLink } from "lucide-react"
...
// //   status: string;
// //   appliedDate: string;
// //   attachments?: Array<string | { url: string; fileName: string }>;
// //   reviewedDate?: string;
// //   approverName?: string;
...
// //           filteredRequests = data.leaveRequests.filter((req: { personType: string }) => req.personType === "student")
// //         }
...
// //       if (response.ok) {
// //         const data = await response.json()
// //         let filteredHistory = data.leaveRequests.filter((req: { status: string }) => req.status === "approved" || req.status === "rejected")
// //         if (user?.role === "Teacher") {
// //           filteredHistory = filteredHistory.filter((req: { personType: string }) => req.personType === "student")
// //         }
// //         // Sort by review date, most recent first
// //         filteredHistory.sort(
// //           (a: { reviewedDate: any; updatedAt: any }, b: { reviewedDate: any; updatedAt: any }) => new Date(b.reviewedDate || b.updatedAt).getTime() - new Date(a.reviewedDate || a.updatedAt).getTime(),
// //         )
...
// //   const handleApproval = async (requestId: string, status: string) => {
...
// //   const handleDocumentView = async (attachment: string | { url: string; fileName: string }) => {
// //     let url, fileName
...
// //   const getAttachmentInfo = (attachment: string | { url: string; fileName: string }) => {
// //     if (typeof attachment === "string") {
